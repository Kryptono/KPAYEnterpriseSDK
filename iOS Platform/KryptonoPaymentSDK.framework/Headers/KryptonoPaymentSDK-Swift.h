...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KryptonoPaymentSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC18KryptonoPaymentSDK10BaseEntity")
...
@interface BaseEntity (SWIFT_EXTENSION(KryptonoPaymentSDK)) <NSCoding>
- (void)encodeWithCoder:(NSCoder * _Nonnull)aCoder;
@end


SWIFT_CLASS("_TtC18KryptonoPaymentSDK11BaseManager")
...
SWIFT_CLASS("_TtC18KryptonoPaymentSDK18BaseViewController")
...
SWIFT_CLASS("_TtC18KryptonoPaymentSDK7Country")
@interface Country : BaseEntity
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC18KryptonoPaymentSDK10CryptoCoin")
@interface CryptoCoin : BaseEntity
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC18KryptonoPaymentSDK13CryptoManager")
...
SWIFT_CLASS("_TtC18KryptonoPaymentSDK17CryptoMarketPrice")
@interface CryptoMarketPrice : BaseEntity
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC18KryptonoPaymentSDK10Enterprise")
@interface Enterprise : BaseEntity
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC18KryptonoPaymentSDK5Macro")
...
SWIFT_CLASS("_TtC18KryptonoPaymentSDK18MainViewController")
...
@interface NSDictionary<KeyType, ObjectType> (SWIFT_EXTENSION(KryptonoPaymentSDK))
- (NSString * _Nullable)toJsonString SWIFT_WARN_UNUSED_RESULT;
@end


@interface NSObject (SWIFT_EXTENSION(KryptonoPaymentSDK))
...
SWIFT_CLASS("_TtC18KryptonoPaymentSDK14NetworkManager")
...
SWIFT_CLASS("_TtC18KryptonoPaymentSDK16SRCountdownTimer")
...
SWIFT_PROTOCOL("_TtP18KryptonoPaymentSDK24SRCountdownTimerDelegate_")
...
SWIFT_CLASS("_TtC18KryptonoPaymentSDK14SettingManager")
