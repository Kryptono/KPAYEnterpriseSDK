...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KPAYEnterprise",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC14KPAYEnterprise10BaseEntity")
...
@interface BaseEntity (SWIFT_EXTENSION(KPAYEnterprise)) <NSCoding>
- (void)encodeWithCoder:(NSCoder * _Nonnull)aCoder;
@end


SWIFT_CLASS("_TtC14KPAYEnterprise11BaseManager")
...
SWIFT_CLASS("_TtC14KPAYEnterprise18BaseViewController")
...
@interface CALayer (SWIFT_EXTENSION(KPAYEnterprise))
- (void)pause;
- (void)resume;
@end


SWIFT_CLASS("_TtC14KPAYEnterprise9Configure")
...
SWIFT_CLASS("_TtC14KPAYEnterprise7Country")
@interface Country : BaseEntity
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC14KPAYEnterprise10CryptoCoin")
@interface CryptoCoin : BaseEntity
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC14KPAYEnterprise13CryptoManager")
...
SWIFT_CLASS("_TtC14KPAYEnterprise17CryptoMarketPrice")
@interface CryptoMarketPrice : BaseEntity
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC14KPAYEnterprise10Enterprise")
@interface Enterprise : BaseEntity
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC14KPAYEnterprise5Macro")
...
SWIFT_CLASS("_TtC14KPAYEnterprise18MainViewController")
...
@interface NSDictionary<KeyType, ObjectType> (SWIFT_EXTENSION(KPAYEnterprise))
...
@interface NSObject (SWIFT_EXTENSION(KPAYEnterprise))
...
SWIFT_CLASS("_TtC14KPAYEnterprise14NetworkManager")
...
SWIFT_CLASS("_TtC14KPAYEnterprise14PrivateManager")
...
SWIFT_CLASS("_TtC14KPAYEnterprise16SRCountdownTimer")
...
SWIFT_PROTOCOL("_TtP14KPAYEnterprise24SRCountdownTimerDelegate_")
...
SWIFT_CLASS("_TtC14KPAYEnterprise14SettingManager")
...
SWIFT_CLASS("_TtC14KPAYEnterprise12ThemeManager")
...
SWIFT_CLASS("_TtC14KPAYEnterprise11ThemeObject")
...
@interface ThemeObject (SWIFT_EXTENSION(KPAYEnterprise))
...
@interface UIColor (SWIFT_EXTENSION(KPAYEnterprise))
+ (UIColor * _Nonnull)defaultSystemTintColor SWIFT_WARN_UNUSED_RESULT;
@end


@interface UIFont (SWIFT_EXTENSION(KPAYEnterprise))
...
@interface UIView (SWIFT_EXTENSION(KPAYEnterprise))
